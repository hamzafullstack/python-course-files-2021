import os, shutil
import pdb # python debugger,,, #set.trace()

# NOTE: You can write every single extensions inside tuples
# why tuples?? because they have very good performance | better speed
dict_extensions = {
...
folderpath = input('enter folder path : ') # user_input for path
